...
- `ai-docs/design-spec-document-conversion-service.md` — original target architecture and phase plan
...
The following items from `ai-docs/design-spec-document-conversion-service.md` were **not implemented** or were **changed** during execution:
